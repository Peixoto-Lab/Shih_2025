"""
Modified on Oct 4 2024

@author: Yi-Chun Shih & Rui Prixoto 

This script is used to analyze Suite2P-based data with txt containg ROI label of E2-Tom+ cells and store as hdf5 files
"""
#%% import packages
import os
